...
import br.com.albinomoreira.utilitario.format.RenavamFormatter;
import br.com.albinomoreira.utilitario.validation.error.RenavamError;
...
public class RenavamValidator implements Validator<String> {
     ...
     * 
     * @see br.com.albinomoreira.utilitario.validation.Validator#assertValid(Object)
     * 
     * @param renavam
